# Uncertainty of the Satellite-Air Temperature Discrepancy (ΔT) across the Urban-Rural Gradient in Flanders

A GeoConformal mini-study applying model-agnostic, spatially-explicit uncertainty
quantification to the discrepancy between satellite land surface temperature (LST) and
...
The goal is not predictive accuracy but **reliability mapping**, which showing where ΔT
...
- **Low R² is considered appropriate here** Surface predictors alone explain
  ...
  error is what makes uncertainty quantification meaningful.
...
- **Landsat 8/9 Collection 2 Level 2** for LST, NDVI (Google Earth Engine), warm season 2021
...
- Copernicus Climate Change Service (C3S) (2019). ERA5-Land hourly data from 1950 to present. Copernicus Climate Change Service Climate Data Store. https://doi.org/10.24381/cds.e2161bac 